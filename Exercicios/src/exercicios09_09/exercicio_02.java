...
public class exercicio_02 {
	public static void main(String[] args) 
	{
		...
		{
			System.out.printf("O ordem crescente é " +num1 +num2 +num3);
			
		}
		if(num2<num1 && num1<num3) 
		{
			System.out.printf("O ordem crescente é "+num2 +num3 +num1);
			
		}
		if(num3<num1 && num1<num2) 
		{
			System.out.printf("O ordem crescente é " +num3+num1+num2);
		}
